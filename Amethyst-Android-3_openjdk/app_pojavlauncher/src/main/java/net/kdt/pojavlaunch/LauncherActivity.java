...
public class LauncherActivity extends BaseActivity {
    ...
    private final FragmentManager.FragmentLifecycleCallbacks mFragmentCallbackListener = new FragmentManager.FragmentLifecycleCallbacks() {
        ...
        public void onFragmentResumed(@NonNull FragmentManager fm, @NonNull Fragment f) {
            ...
            int chromeVisibility = isMainMenu ? View.GONE : View.VISIBLE;
            mAccountSpinner.setVisibility(chromeVisibility);
            mSettingsButton.setVisibility(chromeVisibility);
        }
    };
    ...
    /** Compose dashboard needs lifecycle/viewmodel/savedstate owners on legacy launcher roots. */
